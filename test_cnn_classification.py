...
class SimpleCNN(nn.Module):
    def __init__(self, num_classes=8):
        ...
        # Exact architecture from train_frequency_predictor_colab.py (Lines 290-308)
        ...
        # L1: (1, 1024, 3) -> (16, 1024, 1) -> (16, 256, 1)
        # L2: -> (32, 256, 1) -> (32, 64, 1)
        self.flat_size = 32 * 64  # 2048 features
...
def train():
    print("--- Starting CNN Sanity Check (Architecture Matched) ---")
